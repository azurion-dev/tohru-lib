...
## Booting the Library
```lua
local KanaGui = loadstring(game:HttpGet(('https://raw.githubusercontent.com/jensonhirst/Orion/main/source')))()
```
...
print(KanaGui.Flags["toggle"].Value) -- prints the value of the toggle.
```
